...
#directory with logs
pretrained_dir = "../logs/pretrained_model2/aug3"
...
logger1 = TensorBoardLogger("../logs/ssl2", name="aug3")
logger2 = TensorBoardLogger("../logs/ssl2", name="aug3")
logger3 = TensorBoardLogger("../logs/ssl2", name="aug3")
logger4 = TensorBoardLogger("../logs/ssl2", name="aug3")
...
dm_crops1 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment12')
dm_crops2 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment13')
dm_crops3 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment14')
dm_crops4 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment15')
...
torch.save(model_sim, 'model_sim1_R4_aug6.ckpt')
torch.save(model_sim2, 'model_sim2_R4_aug6.ckpt')
torch.save(model_sim3, 'model_sim3_R4_aug6.ckpt')
torch.save(model_sim4, 'model_sim4_R4_aug6.ckpt')
#%%
