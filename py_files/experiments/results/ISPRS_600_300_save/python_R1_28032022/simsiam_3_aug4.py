...
torch.save(model_sim, 'model_sim1_R4_aug4.ckpt')
torch.save(model_sim2, 'model_sim2_R4_aug4.ckpt')
torch.save(model_sim3, 'model_sim3_R4_aug4.ckpt')
torch.save(model_sim4, 'model_sim4_R4_aug4.ckpt')
#%%
