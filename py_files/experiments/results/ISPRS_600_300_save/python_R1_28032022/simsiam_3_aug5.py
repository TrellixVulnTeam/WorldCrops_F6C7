...
#directory with logs
pretrained_dir = "../logs/pretrained_model2/aug2"
...
logger1 = TensorBoardLogger("../logs/ssl2", name="aug2")
logger2 = TensorBoardLogger("../logs/ssl2", name="aug2")
logger3 = TensorBoardLogger("../logs/ssl2", name="aug2")
logger4 = TensorBoardLogger("../logs/ssl2", name="aug2")
...
dm_crops1 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment8')
dm_crops2 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment9')
dm_crops3 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment10')
dm_crops4 = AugmentationExperiments2(data_dir = data_path, batch_size = batch_size_sim, num_workers = num_workers, experiment='Experiment11')
...
torch.save(model_sim, 'model_sim1_R4_aug5.ckpt')
torch.save(model_sim2, 'model_sim2_R4_aug5.ckpt')
torch.save(model_sim3, 'model_sim3_R4_aug5.ckpt')
torch.save(model_sim4, 'model_sim4_R4_aug5.ckpt')
