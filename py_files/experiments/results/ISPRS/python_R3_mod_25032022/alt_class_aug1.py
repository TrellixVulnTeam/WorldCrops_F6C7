...
logger3 = TensorBoardLogger("../logs/ssl3", name="aug1")
logger4 = TensorBoardLogger("../logs/ssl3", name="aug1")
...
if TRAIN==True:
    ...
    torch.save(model_sim2, 'model_sim2_R1_aug1.ckpt')
    ...
    torch.save(model_sim3, 'model_sim3_R1_aug1.ckpt')
    ...
    torch.save(model_sim4, 'model_sim4_R1_aug1.ckpt')
