...
#directory with logs
pretrained_dir = "../logs/pretrained_model4/aug2"
...
logger1 = TensorBoardLogger("../logs/ssl4", name="aug2")
logger2 = TensorBoardLogger("../logs/ssl4", name="aug2")
logger3 = TensorBoardLogger("../logs/ssl4", name="aug2")
logger4 = TensorBoardLogger("../logs/ssl4", name="aug2")
...
if TRAIN==True:
    ...
    torch.save(model_sim, 'model_sim1_R4_aug2.ckpt')
    ...
    torch.save(model_sim2, 'model_sim2_R4_aug2.ckpt')
    ...
    torch.save(model_sim3, 'model_sim3_R4_aug2.ckpt')
    ...
    torch.save(model_sim4, 'model_sim4_R4_aug2.ckpt')
