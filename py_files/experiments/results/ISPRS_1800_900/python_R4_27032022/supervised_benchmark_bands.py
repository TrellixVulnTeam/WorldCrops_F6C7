...
data_path_rf_train ='../../../../../data/cropdata/Bavaria/sentinel-2/data2016-2018.xlsx'
data_path_rf_test ='../../../../../data/cropdata/Bavaria/sentinel-2/TestData.xlsx'

logger1 = TensorBoardLogger("../logs/supervised", name="supervised1")
logger2 = TensorBoardLogger("../logs/supervised", name="supervised1")
logger3 = TensorBoardLogger("../logs/supervised", name="supervised1")
logger4 = TensorBoardLogger("../logs/supervised", name="supervised1")
...
bavaria_reordered = pd.read_excel(data_path_rf_train, index_col=0)
bavaria_test_reordered = pd.read_excel(data_path_rf_test, index_col=0)
...
for i in range(0,6):
    _ids = _2018[_2018.NC == i].index.unique().tolist()
    
    for id in _ids[:percent]:
        sample = _2018[_2018.index == id]
        samples = pd.concat([samples, sample], axis = 0)
        _2018 = _2018.drop(_2018[_2018.index == id].index)
