...
logger1 = TensorBoardLogger("../logs/supervised", name="supervised2")
logger2 = TensorBoardLogger("../logs/supervised", name="supervised2")
logger3 = TensorBoardLogger("../logs/supervised", name="supervised2")
logger4 = TensorBoardLogger("../logs/supervised", name="supervised2")
